...
public class SPSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = findViewById(R.id.sp_signup_container);

        email = (EditText) findViewById(R.id.sp_signup_email);
        name= (EditText) findViewById(R.id.sp_signup_username);
        password = (EditText) findViewById(R.id.sp_signup_password);
        btn_register = (Button) findViewById(R.id.sp_btn_register);

        mAuth = FirebaseAuth.getInstance();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Users").child("Service Providers");
